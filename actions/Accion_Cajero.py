...
class ActionCajero(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        objetoTrainer = self.getEntidades(tracker, "objetoTrainer")
        operacion = self.getEntidades(tracker, "operacion")

        data = {
            "Accion_Cajero": {
                "cajero": objetoTrainer[0],
